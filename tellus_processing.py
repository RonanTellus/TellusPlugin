...
class TellusProcessing:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TellusProcessing_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Tellus processing')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'TellusProcessing')
        self.toolbar.setObjectName(u'TellusProcessing')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('TellusProcessing', message)
